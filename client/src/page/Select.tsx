...
const initialOptions: optionSelected[] = [
    {
        name: 'test1',
        selected: false,
    },
...
const Dropdown = () => {
    ...
    const [options, setOptions] = useState<optionSelected[]>(initialOptions)
    ...
    useEffect(() => {
        if (optionSelected.length >= 1) setIsOpen(false)
    }, [optionSelected])
    ...
    return (
        ...
        >
            ...
            >
                ...
                {optionSelected.length === 0 && <p>Ajouter un critère</p>}
            ...
            {isOpen && (
                <div className="absolute bottom-[-1]  h-auto left-0 right-0 m-auto bg-red-500 z-10 p-3">
                    {options.map((option) => {
                        return (
                            <div
                                key={option.name}
